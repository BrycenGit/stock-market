...
async function writeDetailCompanyInfo(symbol, divElement) {
  ...
  html += `<tr><button class='btn btn-danger' id='add-to-watch' type='button'>Add to watchlist</button></tr>`
...
$(document).ready(async function () {
  ...
  $('#add-to-watch').on('click', function () {
    addToWatchlist('aapl', watchlistArray);
